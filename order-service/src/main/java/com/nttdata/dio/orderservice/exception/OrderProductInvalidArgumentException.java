...
public class OrderProductInvalidArgumentException extends RuntimeException implements ErrorResponse {
    private final String errorMessage;

    public OrderProductInvalidArgumentException(String errorMessage) {
